  ...
  <div class="topnav" id="myTopnav">
    ...
    <div class="container" id="second-body">
        ...
        <?php
            ...
            $sql = "SELECT * FROM ".$authortable." LIMIT ".($page - 1)*$results_per_page.", ".$results_per_page.";";
        ...
        ?>
            <tr>
                <td id="author_id"><?php echo $row["author_id"] ?></td>
                <td id="image"><?php echo "<center><img src='".$row["pic"]."' style='width:100px;'><center>" ?></td>
                <td id="author_name"><?php echo $row["name"] ?></td>
                <td><?php echo "<a href='author_display.php?page=1&author=".$row["author_id"]."'>View All Books</a>" ?></td>
            </tr>
        <?php
            };
        ?>
